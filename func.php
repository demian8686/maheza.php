...
$header[] = "X-AppVersion: 4.1.1";
$header[] = "X-PhoneModel: Xiaomi,note 4x";
$header[] = "X-DeviceOS: Android,8.1.0";
$header[] = "X-PhoneMake: Xiaomi";
$header[] = "X-AppId: com.gojek.app";
$header[] = "x-user-type: customer";
$header[] = "X-UniqueId: 889406040".time()."57".mt_rand(1000,9999);
...
$header[] = "Content-Type: application/json; charset=UTF-8";
$header[] = "X-AppVersion: 4.1.1";
$header[] = "X-PhoneModel: Oppo,Oppo a3s";
$header[] = "X-DeviceOS: Android,8.1.0";
$header[] = "X-PhoneMake: Oppo";
$header[] = "X-AppId: com.gojek.app";
$header[] = "x-user-type: customer";
$header[] = "X-UniqueId: 889406040".time()."70".mt_rand(1000,9999);
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -7.801".mt_rand(100,999).",110.38".mt_rand(1000,9999);
$header[] = "X-location-Accuracy: 1.0";
...
$c = curl_init("https://goid.gojekapi.com".$url);
    curl_setopt($c, CURLOPT_FOLLOWLOCATION, true);
    curl_setopt($c, CURLOPT_SSL_VERIFYPEER, false);
    if ($data):
    curl_setopt($c, CURLOPT_POSTFIELDS, $data);
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.249443,106.829539";
$header[] = "X-Location-Accuracy: 1.0";
if ($pin):
$header[] = "pin: $pin";
    endif;
